...
namespace 三相智慧能源网关调试软件.ViewModels.DlmsViewModels
{
    ...
    public class Business
    {
        ...
        public Business(DlmsSettingsViewModel dlmsSettingsViewModel, SerialPortMaster serialPortMaster,TcpServerViewModel tcpServerViewModel)
        {
            ...
            LinkLayer = new LinkLayer(serialPortMaster, tcpServerViewModel);
