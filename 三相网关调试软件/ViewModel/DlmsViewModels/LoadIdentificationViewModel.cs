...
namespace 三相智慧能源网关调试软件.ViewModel.DlmsViewModels
{
    public class LoadIdentificationViewModel : ViewModelBase
    {
        ...
        public LoadIdentificationViewModel()
        {
            ...
            {
                var LoadDataBytes = await Client.GetRequestAndWaitResponse(new GetRequest()
                    {GetRequestNormal = new GetRequestNormal(CosemLoadIdentification.GetEarliestLoadIdentification())});
            ...
            GetLatestCommand = new RelayCommand(async () =>
            {
                ...
                {
                    GetRequestNormal =
                        new GetRequestNormal(CosemLoadIdentification.GetCosemLoadIdentificationAttributeDescriptor(),
                            CosemLoadIdentification.GetLatestAccessDescriptor())
                });
                ParseData(LoadDataBytes);
            });
            GetGivenTimeCommand = new RelayCommand<string>(async (t) =>
            {
                ...
                var LoadDataBytes = await Client.GetRequestAndWaitResponse(new GetRequest()
                {
                    GetRequestNormal = new GetRequestNormal(CosemLoadIdentification.GetLoadIdentificationWithTime(dt))
                });
                ParseData(LoadDataBytes);
            });
        }
